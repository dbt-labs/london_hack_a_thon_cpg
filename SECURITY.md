...
credentials, and all data in `seeds/` is synthetic.

If you find committed credentials, key material, or anything resembling real
customer data in this repository or its git history, treat that as a
vulnerability and report it using the process above.

## Out of scope

- Deliberate data-quality problems in `seeds/cpg_records.csv`. These are part of
